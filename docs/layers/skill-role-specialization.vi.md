...
Tách vai trò như founder, engineering manager, designer, QA, reviewer, release engineer để giảm blind spot.

## Khi Nào Dùng

Dùng khi một agent đơn lẻ dễ bỏ sót góc nhìn sản phẩm/kỹ thuật/design/security.
